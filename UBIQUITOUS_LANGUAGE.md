...
| **Aba de status** | Cada aba (Abertas / Em breve / Últimas atividades) que agrupa disciplinas. | seção colapsável, accordion |
...
| **Item de lista** | Linha compacta que representa disciplina Em breve ou Últimas atividades. | card de lista, resumo |
...
- Cada aba exibe zero ou mais **Disciplinas EaD** como **Cards de disciplina** (Abertas) ou **Itens de lista** (Em breve / Últimas atividades).
